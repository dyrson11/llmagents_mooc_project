...
Goal: Your output should be a finalized translation that best reflects the intended meaning of the source text. This translation should be accurate, fluent, and culturally sensitive, with clear reasoning behind your decisions.
"""
...
<translation_assistant_analysis>
